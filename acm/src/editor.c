...
long creature_editor(CREATURE *crit, char **arguments, CREATURE *critp)
{
	...
	OlcInt("IQ",		critp->iq,		1,35)
	OlcInt("Mental Endurance",	critp->me,	1,35)
	OlcInt("Mental Affinity",	critp->ma,	1,35)
	OlcInt("Physical Strength",	critp->ps,	1,35)
	OlcInt("Physical Prowess",	critp->pp,	1,35)
	OlcInt("Physical Endurance",	critp->pe,	1,35)
	OlcInt("Physical Beauty",	critp->pb,	1,35)
	OlcInt("Speed",		critp->spd,		1,35)
	...
	OlcSend("IQ:      	 	%li",	critp->iq			);
	OlcSend("Mental Endurance:	%li",	critp->me			);
	OlcSend("Mental Affinity:	%li",	critp->ma			);
	OlcSend("Physical Strength:	%li",	critp->ps			);
	OlcSend("Physical Prowess:	%li",	critp->pp			);
	OlcSend("Physical Endurance:	%li",	critp->pe			);
	OlcSend("Physical Beauty:	%li",	critp->pb			);
	OlcSend("Speed:          	%li",	critp->spd			);
...
long room_editor(CREATURE *crit, char **arguments, ROOM *room)
{
	...
	{
	sendcritf(crit,"Exit: &+G%-9s&N to &+G%li&N [%s] :: Door:%s  KeyVnum:%li",
